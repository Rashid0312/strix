...
from strix.config import IntegrationSettings, claude_oauth, codex, load_settings
...
def validate_environment() -> None:
    ...
    if claude_oauth.subscription_model(settings.llm.model):
        if not claude_oauth.is_authenticated():
            console.print(
